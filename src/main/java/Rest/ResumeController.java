...
public class ResumeController {
    ...
    public Adresse adresseList;
    public ExperciencePro mesexpList;
    public Scolarites scolaritesList;
    public Langues languesList;
    public CompetenceInfo competenceInfoList;
   /*
    @Autowired
...
*/
   ...
   public void addResume(){
        ...
        competenceInfoList = new CompetenceInfo();
    ...
    Resume getResumeInXMLById(@PathVariable String id){
       //System.out.println (list.resumes.get(1).getName());
        for(int i=0; i<list.resumes.size();i++){
           if( list.resumes.get(i).getName().equals(id)){
